...
<div class="text-gray-600 body-font">
    <div class="flex flex-wrap w-full  container px-5 py-24 mx-auto">
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex flex-wrap ">
            <div class="xl:w-1/5 md:w-1/2 p-4">
                <div class="bg-gray-100 p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="/WebPage/assets/img/certificaciones/CTPAT4.png" alt="content">
            ...
            <div class="xl:w-1/5 md:w-1/2 p-4">
                <div class="bg-gray-100 p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="/WebPage/assets/img/certificaciones/Logo-OEA.png" alt="content">
                    ...
                    <p class="leading-relaxed text-base">
                        ...
                        comercio legítimo y reduciendo controles aduaneros."
            ...
            <div class="xl:w-1/5 md:w-1/2 p-4">
                <div class="bg-gray-100 p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="/WebPage/assets/img/certificaciones/CRM2.png" alt="content">
            ...
            <div class="xl:w-1/5 md:w-1/2 p-4">
                <div class="bg-gray-100 p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="/WebPage/assets/img/certificaciones/ISO.png" alt="content">
            ...
            <div class="xl:w-1/5 md:w-1/2 p-4">
                <div class="bg-gray-100 p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="/WebPage/assets/img/certificaciones/TLIMPIO.png" alt="content">
