...
<section class="text-gray-600 body-font">
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
        <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Sucursal Matriz Nuevo León
            </h1>
            <div class="flex items-center mb-5">
                ...
                <p class="leading-relaxed text-sm sm:text-base ml-4 break-words">Lic. José López Portillo 610, Joyas de Anahuac, 66054 Cd Gral Escobedo, N.L.
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
                    <img src="/sitio/Paguina/WebPage/assets/img/icons/mail.svg" class="text-blue-500 w-6 h-6 font-medium"
                        alt="">
                </div>
                <p class="leading-relaxed text-base ml-4">olpega.monterrey@olpega.net 
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
                    <img src="/sitio/Paguina/WebPage/assets/img/icons/call.svg" class="text-blue-500 w-6 h-6 font-medium"
                        alt="">
                </div>
    ...
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
        <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            ...
            <div class="flex items-center mb-5">
                ...
                <p class="leading-relaxed text-sm sm:text-base ml-4 break-words">Lib. Óscar Flores Tapia 1025, Sin Nombre de Col 18, 25350 Saltillo, Coah.
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
        ...
        <div class="flex flex-col w-full md:w-1/2 h-[400px]">
            <div
                ...
                <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0"
                    marginwidth="0" scrolling="no"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1919.5477499019573!2d-100.90483311325866!3d25.472748848537556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86881355ce683e99%3A0x9ad7f4c9e57956e0!2sOlpega!5e0!3m2!1ses-419!2smx!4v1687973127902!5m2!1ses-419!2smx"
                    style="filter: grayscale(1)contrast(1.2) opacity(0.4);"></iframe>
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                </div>
            </div>
    ...
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
        <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            ...
            <div class="flex items-center mb-5">
                ...
                <p class="leading-relaxed text-sm sm:text-base ml-4 break-words">Acajete-Teziutlán 196, 75016 San José Chiapa, Pue.
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
        ...
        <div class="flex flex-col w-full md:w-1/2 h-[400px]">
            <div
                ...
                <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0"
                    marginwidth="0" scrolling="no"
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d985.2549088495151!2d-97.75278006836886!3d19.25006153166765!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c557a6c43c55f3%3A0xe47016a4b83b62ba!2sDistribuidora%20Olpega%20de%20Puebla%20S.A%20de%20C.V!5e0!3m2!1ses-419!2smx!4v1687963833078!5m2!1ses-419!2smx"
                    style="filter: grayscale(1)contrast(1.2) opacity(0.4);"></iframe>
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                </div>
            </div>
    ...
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
        <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            ...
            <div class="flex items-center mb-5">
                ...
                <p class="leading-relaxed text-sm sm:text-base ml-4 break-words">Carr. Teoloyucan Zumpango km4.5 Barrio San Juan Teoloyucan C.P.54784
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
    ...
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
        <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            ...
            <div class="flex items-center mb-5">
                ...
                <p class="leading-relaxed text-sm sm:text-base ml-4 break-words">Carretera Ejido la Libertad, No. Ext. S/N, No. Int. S/N, Suchiate 90, C.P. 30840,Suchiate Ciudad Hidalgo, Chiapas.
                </p>
            </div>
            <div class="flex items-center mb-5">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-blue-500">
